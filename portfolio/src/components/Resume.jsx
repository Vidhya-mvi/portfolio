...
export default function Resume() {
  ...
  return (
    <section id="resume" className="py-20 px-6 bg-white dark:bg-bgDark text-black dark:text-white">
      <div className="max-w-6xl mx-auto text-center">
        ...
        {showPreview && (
          <div className="w-full h-[750px] mx-auto border border-gray-300 rounded-md shadow-md">
            <Worker workerUrl={`https://unpkg.com/pdfjs-dist@3.11.174/build/pdf.worker.min.js`}>
              <Viewer fileUrl="/Vidhya.pdf" />
            </Worker>
          </div>
        )}
      </div>
